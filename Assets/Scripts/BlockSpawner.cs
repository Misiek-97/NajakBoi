...
{
    [FormerlySerializedAs("tilePrefab")] public GameObject blockPrefab;
     public List<GameObject> blocksList = new (); //Available Tiles
    private readonly List<Block123> _gridBlocks = new (); //Active Tiles in the Grid
    private readonly Dictionary<GameObject, Block123> _blocksDictionary = new (); //Available Tiles Dictionary
    ...
    private void SetUpBlockDictionary()
    {
        ...
        {
            var block = b.GetComponent<Block123>();
    ...
    private Block123 SelectBlock(BlockType blockType, bool isRandom = false)
    {
    ...
    private void InstantiateBlock(BlockType type, Vector2 gridPos, int id, bool random = false)
    {
        ...
        var block = blockGo.GetComponent<Block123>();
    ...
    private void InstantiateBlockFromData(BlockSerializer.BlockData blockData, int id)
    {
        ...
        // Update Tile Parameters and add new tile to the list.
        var blockScript = blockGo.GetComponent<Block123>();
